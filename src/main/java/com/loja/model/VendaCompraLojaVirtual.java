...
import com.loja.enums.StatusVendaLojaVirtual;

@Entity
@Table(name = "vd_cp_loja_virt")
@SequenceGenerator(name = "seq_cp_loja_virt", sequenceName = "seq_cp_loja_virt", allocationSize = 1, initialValue = 1)
public class VendaCompraLojaVirtual implements Serializable {
	...
	@NotNull(message = "O valor do frete deve ser informao!")
	@Column(nullable = false)
