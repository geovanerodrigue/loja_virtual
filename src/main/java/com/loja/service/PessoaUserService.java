...
public class PessoaUserService {
	...
	public PessoaJuridica salvarPessoajuridica(PessoaJuridica juridica) {
		...
		for (Endereco element : juridica.getEnderecos()) {
			element.setPessoa(juridica);
			element.setEmpresa(juridica);
		}
	...
	public PessoaFisica salvarPessoaFisica(PessoaFisica pessoaFisica) {
		//juridica = pesssoaRepository.save(juridica);
			...
			for (Endereco element : pessoaFisica.getEnderecos()) {
				element.setPessoa(pessoaFisica);
